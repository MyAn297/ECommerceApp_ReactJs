      ...
      <footer className="py-4">
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-5">
              <div className="footer-top-data d-flex gap-30 ailgn-items-center">
            ...
            <div className="col-7">
              <div className="input-group bg-white">
                ...
                />
                <button
                  className="input-group-btn border-0 m-1"
                  id="basic-addon2"
                >
                  Subscribe
                </button>
          ...
          <div className="row">
            <div className="col-4">
              ...
              <div>
                ...
                <a
                  href="tel: +84 974155312"
                  className="mt-3 d-block mb-1 text-white"
                >
                  +84 974155312
                </a>
                <a
                  href="mailto: annguyenthimy2907@gmail.com"
                  className="mt-2 d-block mb-0 text-white"
                >
                  annguyenthimy2907@gmail.com"
                </a>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy; {new Date().getFullYear()}; Powered by MyAn297
              </p>
            </div>
          </div>
        </div>
